    ...
    <React.Fragment>
      <div className="section example-info">
        <p>
          ...
          This showcases a scenario where high volume will cause messages to be dropped since React isn't able to... react.
        </p>
      </div>
      <div className="section example-info">
        <h6>Scenario:</h6>
